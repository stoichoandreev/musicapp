...
public class HomeAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        switch (itemType) {
            case HomeAdapterType.ARTIST:
                artistItemDelegate.bindViewHolder((ArtistItemDelegate.ArtistItemViewHolder) holder, viewModel, position);
                break;
            case HomeAdapterType.ALBUM:
                emptyItemDelegate.bindViewHolder((EmptyDelegate.EmptyViewHolder) holder, viewModel, position);
                break;
            case HomeAdapterType.TRACK:
                emptyItemDelegate.bindViewHolder((EmptyDelegate.EmptyViewHolder) holder, viewModel, position);
                break;
