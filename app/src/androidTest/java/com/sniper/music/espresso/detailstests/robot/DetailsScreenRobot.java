...
public class DetailsScreenRobot {
    ...
    public DetailsScreenRobot isArtistTitleWithExpectedInformation(String expectedTitle) {
        onView(withId(R.id.details_title_view)).check(matches(withText(expectedTitle)));
        return this;
    }

    public DetailsScreenRobot isArtistListenersWithExpectedInformation(String expectedListenersInfo) {
        onView(withId(R.id.details_listeners_view)).check(matches(withText(expectedListenersInfo)));
        return this;
    }

    public DetailsScreenRobot isArtistPlayedWithExpectedInformation(String expectedPlayedInfo) {
        onView(withId(R.id.details_play_count_view)).check(matches(withText(expectedPlayedInfo)));
        return this;
    }

    public DetailsScreenRobot areAllViewsWithExpectedInformation() {
        isArtistTitleWithExpectedInformation("Cher");
        isArtistListenersWithExpectedInformation("Artist Listeners : 1076938");
        isArtistPlayedWithExpectedInformation("Was Played : 14952381");
